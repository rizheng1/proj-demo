...
public:
	...
	FBox GravityBoundingBox;
	TArray<FBox> ImportanceVolumes;
	TArray<FBox> GravityVolumes;
	...
	/** Returns true if the specified position is inside any of the gravity volumes. */
	bool IsPointInGravityVolume(const FVector4& Position, float Tolerance) const;
